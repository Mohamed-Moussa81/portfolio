...
let timelineElements = [
  ...
  },
  {
    ...
    description:
      "Facilitated weekly recitation of 50+ students in a collaborative learning environment to solve and explain challenging data structure problems and concepts in Java." +
      "Organized optional review sessions for students to reinforce course material in preparation for exams. Conducted weekly office hours with  5+ students to answer questions regarding coursework and material. ",
  ...
  },
  {
    ...
    description:
      "Educated students on building circuits involving transistors, logic gates, diodes, and other computer hardware components. Troubleshot simple circuits" +
  ...
  },
  {
    ...
    location: "Data Science Research Assistant",
    description:
      ...
      " Processed percent yield for each Organic synthesis reaction using Python by querying data from MySQL database.",
  ...
  },
  {
    ...
    description:
      ...
      " Published Weekly Reports on the increase in compound concentration in Purified crystals.",
